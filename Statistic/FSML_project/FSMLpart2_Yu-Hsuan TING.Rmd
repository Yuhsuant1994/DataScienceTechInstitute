...
with Geometric distribution, $\mu=\frac{1}{p}$ therefor we get p=0.6207325 and we do a random 1000 data from geometric distribution to see if it looks like our y
```{r,fig.width=10}
gp=1/mean(y)
par(mfrow=c(1,2))
hist(y)
